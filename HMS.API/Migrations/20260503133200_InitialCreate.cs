        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Waitlists_AspNetUsers_GuestId",
                        column: x => x.GuestId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Waitlists_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "BookingAncillaryServices",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BookingId = table.Column<int>(type: "integer", nullable: false),
                    AncillaryServiceId = table.Column<int>(type: "integer", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    TotalPrice = table.Column<decimal>(type: "numeric(10,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingAncillaryServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingAncillaryServices_AncillaryServices_AncillaryService~",
                        column: x => x.AncillaryServiceId,
                        principalTable: "AncillaryServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingAncillaryServices_Bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingAncillaryServices_AncillaryServiceId",
                table: "BookingAncillaryServices",
                column: "AncillaryServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingAncillaryServices_BookingId",
                table: "BookingAncillaryServices",
                column: "BookingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Waitlists_GuestId",
                table: "Waitlists",
                column: "GuestId");

            migrationBuilder.CreateIndex(
                name: "IX_Waitlists_HotelId",
                table: "Waitlists",
                column: "HotelId");
        }
